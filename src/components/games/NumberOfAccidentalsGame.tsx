                    ...
                    {new Array<Extract<Accidental, "#" | "b">>("#", "b").map(
                      (accidental) => (
                        <Button
                          key={accidental}
                          active={
                            questions[currentQuestionIndex].accidentalAnswer ===
                            accidental
                          }
          ...
          {questions.map((question, questionNumber) => (
            <Card>
              ...
              <Card.Body>
                ...
                <div>
                  <b>Right answer: </b>
                  {question.accidentalsNumber} {question.accidental}
                </div>
                <div>
                  <b>Your answer: </b>
                  {question.accidentalsNumberAnswer} {question.accidentalAnswer}
                </div>
              </Card.Body>
            </Card>
          ))}
